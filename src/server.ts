...
const properties = [
  {
    id: 1,
    title: 'Light-filled home in HSR',
    locality: 'HSR Layout',
    rent: '₹28K',
    type: 'Apartment',
    bedrooms: '2 BHK',
    position: { top: '0%', left: '0%' },
    amenities: ['Parking', 'Furnished', 'Power backup'],
    verified: true,
    latitude: 12.9116,
    longitude: 77.6389,
    status: 'rented',
  ...
  {
    id: 3,
    title: 'Sunny apartment for two',
    locality: 'Koramangala',
    rent: '₹24K',
    type: 'Apartment',
    bedrooms: '1 BHK',
    position: { top: '0%', left: '0%' },
    amenities: ['Furnished', 'Gym'],
    verified: false,
    latitude: 12.9352,
    longitude: 77.6245,
    status: 'rented',
  ...
  {
    id: 4,
    title: 'Room with a garden view',
    locality: 'Whitefield',
    rent: '₹18K',
    type: 'Room',
    bedrooms: '1 BHK',
    position: { top: '0%', left: '0%' },
    amenities: ['Power backup', 'Pet friendly'],
    verified: true,
    latitude: 12.9698,
    longitude: 77.7499,
    status: 'available',
...
app.get('/api/broker/dashboard', (_req, res) => {
  ...
  const commissionEarned = rentedListings.reduce(
    (total, property) => total + property.commissionEarned,
    0,
  );
  res.json({
    properties,
